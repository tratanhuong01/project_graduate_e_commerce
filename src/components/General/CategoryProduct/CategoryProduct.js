...
function CategoryProduct(props) {
  ...
  //
  return (
    <div className="xl:w-4/5 w-full mx-auto p-4 relative">
      <LabelCategoryProduct products={products} />
      <div
        className="w-12 h-12 bg-gray-300 bg-opacity-50 rounded-full cursor-pointer absolute top-1/2 transform -translate-y-1/2 -left-6 z-50 flex justify-center items-center text-gray-800  
      "
      >
      ...
      <div className="w-12 h-12 bg-organce-second bg-opacity-50 rounded-full cursor-pointer absolute top-1/2 transform -translate-y-1/2 -right-6 z-50 flex justify-center items-center  text-white shadow-lg-organce">
