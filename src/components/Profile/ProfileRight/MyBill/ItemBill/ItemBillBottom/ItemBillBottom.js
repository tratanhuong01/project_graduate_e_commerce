  ...
  return (
    <div className="w-full flex items-center text-gray-600">
      ...
      <div className="w-2/3 flex justify-end items-center">
        ...
        <button
          className="border-2 border-solid border-organce px-4 py-2 text-gray-600 font-semibold 
        text-sm"
        >
          Xem chi tiết đơn hàng
        </button>
        <button className="border-2 ml-6 border-solid border-organce px-4 py-2 text-gray-600 font-semibold text-sm">
          Hủy đơn hàng
        </button>
      </div>
    </div>
