...
function SelectCustom(props) {
  ...
  return (
    <>
      ...
      <div className="w-full p-2.5 my-3 border-2 border-solid pl-10 mt-2 relative dark:bg-dark-third dark:border-dark-third rounded-lg border-gray-300 cursor-pointer bg-gray-100 font-semibold">
