...
function ItemAttributeFilter(props) {
  ...
  return (
    <div
      className={`mx-2 px-2 mb-2 py-0.5 rounded flex items-center relative border-2 shadow-sm border-solid
      shadow-sm cursor-pointer border-gray-300 dark:border-dark-third zIndex__${index} ${index === indexCurrent
