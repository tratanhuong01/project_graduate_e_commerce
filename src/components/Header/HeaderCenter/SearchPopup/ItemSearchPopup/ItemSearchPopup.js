...
function ItemSearchPopup(props) {
  ...
  //
  return (
    <div className="w-full p-2 border-b-2 border-solid border-gray-100 dark:border-dark-third shadow-sm flex items-center">
      <img
      ...
      <div className="flex justify-items-center flex-col pl-3">
        <p className="mb-1 font-bold text-xm dark:text-gray-300">
          <Link to={`${Config.PAGE_DETAIL_PRODUCT}/${product.slug}`}>
            {product.nameLineProduct}
          </Link>
        </p>
        <p className="text-organce text-sm font-semibold dark:text-gray-300">
