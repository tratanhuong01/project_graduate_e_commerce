...
//
export const LOAD_SLUG_CONDITION = "LOAD_SLUG_CONDITION";
//
export const RESET_FILTER_PRODUCT = "RESET_FILTER_PRODUCT";
//
export const RESET_ALL_FILTER_SORTER_SEARCH_LIST_PRODUCT =
  "RESET_ALL_FILTER_SORTER_SEARCH_LIST_PRODUCT";
//
